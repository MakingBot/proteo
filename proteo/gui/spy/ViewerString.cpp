 ...
 *
 * */
ViewerString::ViewerString(quint8 propid, bool readonly, int step, int min, int max)
 ...
 *
 * */
void ViewerString::setValueFromVariant(const proteo::core::Variant& variant)
{
 ...
 *
 * */
void ViewerString::onValueChange(double value)
{
    Q_UNUSED(value);
    m_setButton.change();
}
